...
import { Navbar, Nav, Icon, Dropdown, Avatar, Button } from 'rsuite';
            ...
            if (!cookie.user) return (
              <>
                ...
                <Dropdown title={<Avatar style={{ margin: '-25%' }} src="/img/guest.png" circle />} placement="bottomEnd">
                  <Dropdown.Item icon={<Icon icon="sign-in" />}><Button onClick={() => setLoginShow(true)} >Log in</Button></Dropdown.Item>
                  <Dropdown.Item icon={<Icon icon="user-plus" />}><Button onClick={() => setRegisterShow(true)} >Register</Button></Dropdown.Item>
                </Dropdown>
